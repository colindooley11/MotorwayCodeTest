...
{
    private FraudAwayProviderTestAdapter _fraudAwayProvider = null!;
    private FraudCheckResponse _result = null!;
    private MotorwayPaymentsCodeTest.Domain.OrderFraudCheck _orderFraudCheck = null!;
    private decimal _riskScoreThreshold;
    private FraudAwayResult _fraudAwayResult = null!;
    private SaveFraudAwayDetailsCommandTestAdapter _saveFraudAwayDetailsCommand = null!;
    private ByPassThresholdDetailsCommandTestAdapter _byPassThresholdDetailsCommandTestAdapter = null!;
    private readonly Guid _customerId = Guid.Parse("57406e32-6a43-4dae-81d9-38bd7e349d54");
    private decimal _bypassAmountThreshold;
    private SimpleFraudResult _simpleFraudResult = null!;
    private ISimpleFraudProvider _simpleFraudProvider = null!;
    ...
    private async Task The_Fraud_Check_Is_Requested(string orderId)
    {
        ...
        var defaultFraudCheck =
            new DefaultFraudBypassFraudCheckService(_byPassThresholdDetailsCommandTestAdapter, new ByPassOptions { BypassThresholdAmount =  _bypassAmountThreshold });
        ...
        var fraudAwayFraudCheckService = new FraudAwayFraudCheckService(simpleFraudCheck, _fraudAwayProvider,
            _saveFraudAwayDetailsCommand, new RiskScoreOptions { RiskScoreThreshold =  _riskScoreThreshold});
