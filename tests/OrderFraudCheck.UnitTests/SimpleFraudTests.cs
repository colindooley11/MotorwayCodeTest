...
public class SimpleFraudTests : FraudTestsBase
{
    ...
    private SaveSimpleFraudDetailsCommandAdapter _saveSimpleFraudDetailsCommandAdapter = null!;
    private SimpleFraudProviderTestAdapter _simpleFraudProviderTestAdapter = null!;
    private OrderFraudCheckDetails _orderFraudCheckDetails = null!;
    private FraudAwayProviderTestAdapter _fraudAwayProvider = null!;
    private SaveFraudAwayDetailsCommandTestAdapter _saveFraudAwayDetailsCommandTestAdapter = null!;
    ...
    private async Task The_Order_Fraud_Check_Is_Requested(string orderId)
    {
        ...
        var fraudAwayFraudCheckService = new FraudAwayFraudCheckService(simpleFraudFraudCheckService,
            _fraudAwayProvider,
            _saveFraudAwayDetailsCommandTestAdapter, new RiskScoreOptions { RiskScoreThreshold = _riskScoreThreshold });
